...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "brandentanga-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/dyelb"
  #   chef.validation_client_name = "dyelb-validator"
  #   chef.validation_key_path = ".chef/dyelb-validator.pem"
  # end
end
